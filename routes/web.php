...
use App\Livewire\Accounting\AccountsIndex as AccountingAccountsIndex;
use App\Livewire\Accounting\BalancePage as AccountingBalancePage;
use App\Livewire\Accounting\BalanceSheetPage as AccountingBalanceSheetPage;
use App\Livewire\Accounting\EntriesIndex as AccountingEntriesIndex;
use App\Livewire\Accounting\IncomeStatementPage as AccountingIncomeStatementPage;
use App\Livewire\Accounting\JournalBookPage as AccountingJournalBookPage;
use App\Livewire\Accounting\JournalsIndex as AccountingJournalsIndex;
use App\Livewire\Accounting\LedgerPage as AccountingLedgerPage;
use App\Livewire\Accounting\OperationsMap as AccountingOperationsMap;
use App\Livewire\Accounting\SettingsPage as AccountingSettingsPage;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('accounting/accounts', AccountingAccountsIndex::class)->middleware('role:owner,manager')->name('accounting.accounts');
    Route::get('accounting/journals', AccountingJournalsIndex::class)->middleware('role:owner,manager')->name('accounting.journals');
    Route::get('accounting/entries', AccountingEntriesIndex::class)->middleware('role:owner,manager')->name('accounting.entries');
    Route::get('accounting/balance', AccountingBalancePage::class)->middleware('role:owner,manager')->name('accounting.balance');
    Route::get('accounting/ledger', AccountingLedgerPage::class)->middleware('role:owner,manager')->name('accounting.ledger');
    Route::get('accounting/journal-book', AccountingJournalBookPage::class)->middleware('role:owner,manager')->name('accounting.journal-book');
    Route::get('accounting/income-statement', AccountingIncomeStatementPage::class)->middleware('role:owner,manager')->name('accounting.income-statement');
    Route::get('accounting/balance-sheet', AccountingBalanceSheetPage::class)->middleware('role:owner,manager')->name('accounting.balance-sheet');
    Route::get('accounting/operations', AccountingOperationsMap::class)->middleware('role:owner,manager')->name('accounting.operations');
    Route::get('accounting/settings', AccountingSettingsPage::class)->middleware('role:owner,manager')->name('accounting.settings');
