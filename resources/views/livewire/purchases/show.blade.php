    ...
    <div class="grid gap-6 xl:grid-cols-[1.55fr_0.95fr]">
        <div class="rounded-[28px] border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div class="border-b border-slate-100 px-6 py-4">
                ...
                <p class="mt-1 text-sm text-slate-500">Quantités commandées, reçues et coût unitaire par article.</p>
            </div>
                                ...
                                @foreach ($purchaseOrder->items as $item)
                                    <tr class="hover:bg-slate-50/70">
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="mt-1 text-xs text-slate-500">Coût moyen unitaire calculé pour l'entrée en stock.</div>
                                        </td>
