...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('purchases.index')" :active="request()->routeIs('purchases.*')" wire:navigate>
                        Achats
                    </x-nav-link>
                    <x-nav-link :href="route('stock-transfers.create')" :active="request()->routeIs('stock-transfers.*')" wire:navigate>
                        Transferts
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('inventory-counts.create')" :active="request()->routeIs('inventory-counts.*')" wire:navigate>
                        Inventaire
                    </x-nav-link>
                    @if ($isManager)
                        <x-nav-link :href="route('reports.financial')" :active="request()->routeIs('reports.*')" wire:navigate>
                            Rapports
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('purchases.index')" :active="request()->routeIs('purchases.*')" wire:navigate>
                Achats
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('stock-transfers.create')" :active="request()->routeIs('stock-transfers.*')" wire:navigate>
                Transferts
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('inventory-counts.create')" :active="request()->routeIs('inventory-counts.*')" wire:navigate>
                Inventaire
            </x-responsive-nav-link>
            @if ($isManager)
                <x-responsive-nav-link :href="route('reports.financial')" :active="request()->routeIs('reports.*')" wire:navigate>
                    Rapports
                </x-responsive-nav-link>
            @endif
        </div>
