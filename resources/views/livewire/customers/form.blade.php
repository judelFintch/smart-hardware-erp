<div class="form-section">
    <div class="section-header">
        ...
        <a class="btn btn-secondary" href="{{ route('customers.index') }}" wire:navigate>Retour</a>
    </div>
    <form wire:submit.prevent="save" class="section-body space-y-6" data-autosave data-autosave-key="customer-form-{{ $customer?->id ?? 'new' }}">
        <div class="form-grid">
            <div>
        ...
        <div class="flex items-center justify-end gap-2">
            <a class="btn btn-secondary" href="{{ route('customers.index') }}" wire:navigate>Annuler</a>
